  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Accounts</h2>
        <button
          onClick={handleAdd}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {accounts.map((account) => {
          ...
          return (
            <div
              key={account.id}
              className={`p-6 bg-white dark:bg-gray-800 rounded-xl shadow-md border hover:shadow-lg transition-all relative overflow-hidden ${
                isExcluded ? "border-gray-200 dark:border-gray-600 opacity-60" : "border-gray-100 dark:border-gray-700"
              }`}
            >
              <div
              ...
              <div className="relative z-10">
                  ...
                  <div className="flex flex-col gap-2 items-end">
                    ...
                    <div className="flex gap-1">
                      <button
                        ...
                        className={`p-1.5 rounded-lg transition-colors ${
                          isExcluded
                            ...
                            : "text-teal-500 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 hover:bg-teal-50 dark:hover:bg-teal-900/30"
                        }`}
                        title={
                      ...
                      <button
                        ...
                        className="p-1.5 text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-lg transition-colors"
                        title="Edit Account"
                      >
                        <Pencil size={16} />
                      </button>
                      <button
                        ...
                        className="p-1.5 text-red-400 hover:text-red-600 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-lg transition-colors"
                ...
                <div className="mt-8">
                  <p className="text-sm text-gray-400 dark:text-gray-500 mb-1">Current Balance</p>
      ...
      {viewingTransactionsAccount && (
        ...
        >
          <div className="flex flex-col h-[70vh] -mx-6 px-6">
            ...
            <div className="mb-4 space-y-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-9 py-2 text-sm border border-gray-200 dark:border-gray-600 rounded-lg outline-none focus:ring-2 focus:ring-teal-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500"
                />
                {searchQuery && (
                  <button
              ...
              <div className="flex flex-wrap gap-2 items-center justify-between">
                ...
                <input
                  ...
                  className="px-3 py-1.5 text-sm border border-gray-200 dark:border-gray-600 rounded-lg outline-none focus:ring-2 focus:ring-teal-500 bg-white dark:bg-gray-700 text-gray-600 dark:text-gray-300"
                />
              </div>
            </div>
            ...
            {/* Pagination Footer */}
            {totalPages > 1 && (
              <div className="pt-4 mt-2 border-t border-gray-100 dark:border-gray-700 flex items-center justify-between">
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
